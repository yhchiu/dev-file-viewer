const INLINE_PREVIEW_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    inlineOutlineChangedFiles: 'Changed files',
    inlineOutlineSymbols: 'Symbols',
  ...
  zh_CN: Object.freeze({
    ...
    inlineOutlineChangedFiles: '已变更的文件',
    inlineOutlineSymbols: '符号',
  ...
  zh_TW: Object.freeze({
    ...
    inlineOutlineChangedFiles: '已變更的檔案',
    inlineOutlineSymbols: '符號',
