...
import { getArrowUpIcon, getArrowDownIcon } from '../core/ui/icons.js';
...
class DevFileViewerApp {
  constructor() {
    ...
    this.fileTabs = new FileTabsController(this);
  ...
  async clearViewerForFailedDocument(fileNode = {}) {
    ...
    this.currentDoc = null;
    this.currentDocKey = '';
    this.fileTabs.activeTabKey = '';
    this.fileTabs.renderFileTabs();
    this.clearSourceLineHighlight();
    this.outline.clearToc();
    this.setDocumentReloadEnabled(false);
